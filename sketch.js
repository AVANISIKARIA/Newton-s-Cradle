...
function setup() {
  ...
  roof = new Roof(325,100,500,20);


  bobObject1=new Bob(175,500,75);
  bobObject2=new Bob(250,500,75);
  bobObject3=new Bob(325,500,75);
  bobObject4=new Bob(400,500,75);
  bobObject5=new Bob(475,500,75);
...
function keyPressed(){
	if(keyCode === UP_ARROW){
		Matter.Body.applyForce(bobObject1.body,bobObject1.body.position,{x:-350,y:-50});
	}
}
